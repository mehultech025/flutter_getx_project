...
HomeListResModel homeListResModelFromJson(String str) => HomeListResModel.fromJson(json.decode(str));
String homeListResModelToJson(HomeListResModel data) => json.encode(data.toJson());
class HomeListResModel {
  HomeListResModel({
      num? page, 
      num? perPage, 
      num? total, 
  ...
  HomeListResModel.fromJson(dynamic json) {
    _page = json['page'];
  ...
  List<Data>? _data;
  Support? _support;
HomeListResModel copyWith({  num? page,
  num? perPage,
  num? total,
  num? totalPages,
  List<Data>? data,
  Support? support,
}) => HomeListResModel(  page: page ?? _page,
